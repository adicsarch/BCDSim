...
class subtraction
{
      public : 
             ...
             {
             cout<<"\nTaking 10's complement of the second number"<<endl;	
               int a[10],b[10],sub[10],c[10],d[10];
                  ...
                  cout<<"\nSub is"<<endl<<sum<<endl<<endl;
                  cout<<"\nThe final result is : "<<endl;
                  convert_display(sum);
                  }
...
void sub2(int n,int m)
{
  ...
  while(o>0)
	...
	for(int i=0;i<cs;i++)
	  ...
	  cout<<"\nTo get 9's complement subtracting from : "<<nin<<endl;	
	
	  cout<<"\nTaking 9's complement of the second number : "<<endl;	
      int k=nin-m;
      convert_display(k);
      cs=0;
